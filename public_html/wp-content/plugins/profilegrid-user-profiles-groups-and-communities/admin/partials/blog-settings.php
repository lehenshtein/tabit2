        ...
        <div class="uimrow">
            ...
            <div class="uiminput">
              <select name="pm_blog_post_from" id="pm_blog_post_from">
                <option value="profilegrid_blogs" <?php selected($dbhandler->get_global_option_value('pm_blog_post_from','profilegrid_blogs'),'profilegrid_blogs'); ?>><?php _e('User Blogs','profile-magic');?> </option>
                <option value="post" <?php selected($dbhandler->get_global_option_value('pm_blog_post_from','profilegrid_blogs'),'post'); ?>><?php _e('Posts','profile-magic');?> </option>
                <option value="both" <?php selected($dbhandler->get_global_option_value('pm_blog_post_from','profilegrid_blogs'),'both'); ?>><?php _e('Both','profile-magic');?> </option>
              </select>
            </div>
